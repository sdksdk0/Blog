...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/mall/css/taotao.css" media="all" />
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/mall/css/pshow.css" media="all" />
...
<div class="w">
	<div class="breadcrumb">
		<strong><a href="#">博客云</a></strong><span>&nbsp;&gt;&nbsp;<a href="http://localhost:8085/mall?q=%E6%95%99%E7%A8%8B" >积分商城</a>
...
<div class="w">
	...
	博客云向您保证所售商品均为正品行货，淘淘自营商品开具机打发票或电子发票。凭质保证书及淘淘发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由淘淘联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。淘淘还为您提供具有竞争力的商品价格和<a href="http://www.jd.com/help/kdexpress.aspx" target="_blank">运费政策</a>，请您放心购买！
	<br /><br />
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/mall/js/lib-v1.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/mall/js/product.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/mall/js/iplocation_server.js"></script>
<script type="text/javascript">
	var itemControl = {
			param:{
				descUrl:"/item/desc/",
