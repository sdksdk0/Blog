		...
		<div class="easyui-accordion" data-options="fit:true,border:false">
			<div title="常用操作" data-options="selected:true,iconCls:'icon-item'"
				...
				<a href="javascript:openTab('写博客','writeBlog','icon-writeblog')"
					...
					href="javascript:openTab('评论审核','commentReview','icon-review')"
					class="easyui-linkbutton"
			...
			<div title="博客管理" data-options="iconCls:'icon-bkgl'"
				style="padding:10px;">
				<a href="javascript:openTab('写博客','item-add','icon-writeblog')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-writeblog'"
					style="width: 150px;">写博客</a> <a
					href="javascript:openTab('博客信息管理','blogManage','icon-bkgl')"
					class="easyui-linkbutton"
			...
			<div title="博客类别管理" data-options="iconCls:'icon-bklb'"
				style="padding:10px">
				<a
					href="javascript:openTab('博客类别信息管理','blogTypeManage','icon-bklb')"
					class="easyui-linkbutton"
			...
			<div title="评论管理" data-options="iconCls:'icon-plgl'"
				...
				<a
					...
					href="javascript:openTab('评论信息管理','commentManage','icon-plgl')"
					class="easyui-linkbutton"
			...
			<div title="个人信息管理" data-options="iconCls:'icon-grxx'"
				style="padding:10px">
				<a
					href="javascript:openTab('修改个人信息','modifyInfo','icon-grxxxg')"
					class="easyui-linkbutton"
			...
			<div title="系统管理" data-options="iconCls:'icon-system'"
				style="padding:10px">
				<a href="javascript:openTab('友情链接管理','linkManage','icon-link')"
					class="easyui-linkbutton"
