	    ...
	    <table cellpadding="5">
	        <tr>
	            ...
	            <td>
	            	...
	            	<input type="hidden" name="cid" style="width: 150px;"></input>
	            </td>
	            <td>商品标题:</td>
	            <td><input class="easyui-textbox" type="text" name="title" data-options="required:true" style="width: 150px;"></input></td>
