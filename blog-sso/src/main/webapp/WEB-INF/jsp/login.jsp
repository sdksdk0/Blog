	...
	<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
		...
		<DIV style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
	        ...
	        <SPAN style="float: right;"> 
	              <input type="button"  id="loginsubmit"  style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" value="登录"/> 
	         </SPAN>   
	         <SPAN style="float: left;"> 
	              <input type="button"  id="reg"  style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" value="注册"/> 
	         </SPAN>       
	         </P>
	    </DIV>
	</DIV>
...
<div align="center" style="padding-top: 30px" >
 ...
 Copyright © 2015-2016 荣登文化(RD工程)
			...
			doLogin:function() {
				$.post("/sso/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						...
						$("#error").html("登录失败，原因是:"+data.msg.substr(0,50));
	...
	$(function(){
		...
		$("#reg").click(function(){
			location="${pageContext.request.contextPath}/page/register";
		});
